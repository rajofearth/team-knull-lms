import { Calendar, Globe, MapPin, Pencil } from "lucide-react";
        ...
        <div className="flex flex-col gap-4 flex-1">
          ...
          <div className="flex items-center gap-5 mt-2">
              ...
              <Link
                href={
                  profile.socials.linkedin.startsWith("http")
                    ? profile.socials.linkedin
                    : `https://linkedin.com/in/${profile.socials.linkedin}`
                }
                target="_blank"
                rel="noreferrer"
            ...
            {profile.socials?.github && (
              <Link
                href={
                  profile.socials.github.startsWith("http")
                    ? profile.socials.github
                    : `https://github.com/${profile.socials.github}`
                }
                target="_blank"
                rel="noreferrer"
                className="text-muted-foreground hover:text-foreground transition-colors"
            ...
            {profile.socials?.google && (
              <Link
                href={`mailto:${profile.socials.google}`}
                className="text-muted-foreground hover:text-foreground transition-colors"
              >
