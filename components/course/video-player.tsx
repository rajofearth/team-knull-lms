    ...
    <div className="w-full aspect-video relative rounded-xl overflow-hidden bg-video-bg shadow-float border border-video-border/20">
      ...
      <div className="flex items-center justify-between py-2.5 px-4 bg-video-header border-b border-video-border">
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center mb-[-10px] py-1.5 px-3 gap-2 bg-video-border border-b border-video-header rounded-t-sm">
            ...
            <span className="text-text-description font-sans text-xs">
              index.html
            </span>
      ...
      <div className="p-6 font-mono text-sm leading-relaxed text-video-text opacity-90 overflow-hidden">
        <div className="flex gap-4">
          <span className="text-text-secondary text-right w-6 select-none pr-2">
            1
          </span>
          <span>
            <span className="text-code-tag">&lt;!DOCTYPE</span>{" "}
        ...
        <div className="flex gap-4">
          ...
          <span>
            &lt;<span className="text-code-tag">html</span>{" "}
            <span className="text-code-attr">lang</span>=
            <span className="text-code-string">"en"</span>&gt;
          </span>
        </div>
        <div className="flex gap-4">
          <span className="text-text-secondary text-right w-6 select-none pr-2">
          ...
          <span>
            &lt;<span className="text-code-tag">head</span>&gt;
          </span>
        </div>
        <div className="flex gap-4 pl-4">
          ...
          <span>
            &lt;<span className="text-code-tag">meta</span>{" "}
            <span className="text-code-attr">charset</span>=
            <span className="text-code-string">"UTF-8"</span>&gt;
          </span>
        </div>
        <div className="flex gap-4 pl-4">
          <span className="text-text-secondary text-right w-6 select-none pr-2">
          ...
          <span>
            ...
            <span className="text-code-string">"viewport"</span>{" "}
            <span className="text-code-attr">content</span>=
        ...
        <div className="flex gap-4 pl-4">
          ...
          <span>
            &lt;<span className="text-code-tag">title</span>&gt;My Website&lt;/
            <span className="text-code-tag">title</span>&gt;
          </span>
        </div>
        <div className="flex gap-4">
          <span className="text-text-secondary text-right w-6 select-none pr-2">
        ...
        <div className="flex gap-4">
          ...
          <span>
            &lt;<span className="text-code-tag">body</span>&gt;
          </span>
        </div>
        <div className="flex gap-4 pl-4">
          <span className="text-text-secondary text-right w-6 select-none pr-2">
          ...
          <span>
            &lt;<span className="text-code-tag">header</span>&gt;
          </span>
        </div>
        <div className="flex gap-4 pl-8">
          ...
          <span>
            &lt;<span className="text-code-tag">h1</span>&gt;Welcome to Web
            Development&lt;/<span className="text-code-tag">h1</span>&gt;
          </span>
        </div>
        <div className="flex gap-4 pl-4">
          <span className="text-text-secondary text-right w-6 select-none pr-2">
        ...
        <div className="flex gap-4 pl-4">
          ...
          <span>
            &lt;<span className="text-code-tag">main</span>&gt;
          </span>
        </div>
        <div className="flex gap-4 pl-8">
          <span className="text-text-secondary text-right w-6 select-none pr-2">
          ...
          <span>
            &lt;<span className="text-code-tag">p</span>&gt;Building awesome
            websites, one line of code at a time.&lt;/
        ...
        <div className="flex-1 flex flex-col gap-3 mb-2">
          ...
          <div className="flex justify-between items-center">
            ...
            <div className="flex items-center gap-4.5">
              ...
              <span className="text-canvas font-sans font-bold text-sm cursor-pointer hover:opacity-80">
                1x
              </span>
