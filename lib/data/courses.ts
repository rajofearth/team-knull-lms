...
export const courses: Record<string, CourseData> = {
  "web-dev": {
    ...
    description:
      "Learn HTML, CSS, JavaScript, and modern web development by building real-world projects. From zero to job-ready.",
    rating: 4.7,
    reviewsCount: 892,
    ...
    modules: [
      {
        ...
        description:
          "The World Wide Web operates on a fundamental client-server architecture. When a user requests a webpage, their browser acts as the client, sending an HTTP request across the internet to a server hosting the site's files. The Domain Name System (DNS) functions as the internet's directory, translating human-readable domain names into IP addresses. At the structural core of these delivered files is HTML (HyperText Markup Language). HTML is not a programming language, but a markup language that utilizes a system of tags to define the semantic structure and content of a document, instructing the browser on how to interpret headings, paragraphs, links, and media elements within the document object model.",
        lessonsCompleted: 5,
        totalLessons: 5,
        lessons: [
          {
            ...
            description:
              "Learn what web development is and the roles of HTML, CSS, and JS.",
          },
          {
            id: "l2",
            title: "2. How the Web Works",
            duration: "06:18",
            isCompleted: true,
            videoUrl: "https://example.com/v2",
            description:
              "Understand DNS, servers, and how browsers render pages.",
          },
          {
            id: "l3",
            ...
            description: "Install VS Code and essential extensions.",
          },
          {
            id: "l4",
            title: "4. HTML Basics",
            ...
            description: "Learn the core structure of an HTML document.",
          },
          {
            id: "l5",
            title: "5. HTML Elements and Structure",
            duration: "10:15",
            isCompleted: true,
            isActive: true,
            videoUrl: "https://example.com/v5",
            description:
              "Deep dive into semantic HTML elements like header, main, and footer.",
          },
        ],
      },
      {
        ...
        lessons: [
          ...
          },
          {
            ...
            description:
              "Making your website look great on mobile phones and tablets using media queries.",
          },
        ],
      },
      {
        ...
        lessons: [
          {
            id: "l12",
            title: "12. JS Syntax and Variables",
            duration: "08:10",
            isCompleted: true,
            videoUrl: "https://example.com/v12",
            description: "Let, const, and basic syntax rules.",
          },
          {
            id: "l13",
            title: "13. Data Types and Operators",
            duration: "10:30",
            isCompleted: true,
          ...
          {
            id: "l14",
            title: "14. Functions and Scope",
            duration: "13:45",
            isCompleted: true,
            videoUrl: "https://example.com/v14",
            description:
              "Creating reusable blocks of code and understanding lexical scope.",
          },
          {
            id: "l15",
            title: "15. Conditionals and Loops",
            duration: "11:20",
            isCompleted: true,
            videoUrl: "https://example.com/v15",
            description:
              "If/else statements, switch cases, for, and while loops.",
          },
          {
            id: "l16",
            title: "16. Arrays and Objects",
            duration: "14:50",
            isCompleted: true,
          ...
          {
            id: "l17",
            title: "17. DOM Manipulation",
            duration: "16:15",
            isCompleted: true,
            videoUrl: "https://example.com/v17",
            description:
              "Selecting HTML elements and modifying them using JavaScript.",
          },
          {
            id: "l18",
            title: "18. Event Listeners",
            duration: "12:40",
            isCompleted: true,
            videoUrl: "https://example.com/v18",
            description:
              "Making web pages interactive by responding to user clicks and keystrokes.",
          },
        ],
      },
      {
    ...
    overview: {
      ...
      detailedDescription:
        "This comprehensive Web Development Bootcamp is designed to take you from a complete beginner to a confident web developer. You'll learn the core technologies of the web — HTML, CSS, and JavaScript — and build real-world projects that you can add to your portfolio.\n\nBy the end of this course, you'll be able to build responsive websites, create interactive web applications, and understand modern development tools and workflows.",
      features: [
        {
      ...
      whoThisCourseIsFor: [
        ...
        },
        {
          ...
          description: "Switch careers and build in-demand skills",
          icon: "refresh-cw",
        },
        {
          title: "Students & Hobbyists",
          description: "Build projects and bring your ideas to life",
          icon: "laptop",
        },
      ],
      syllabus: [],
  ...
  "uiux-design": {
    ...
    description:
      "Learn the basics of UI/UX design and create beautiful user interfaces with Figma and design principles.",
    rating: 4.8,
    reviewsCount: "1.2k",
    studentsCount: "8,540",
    level: "Beginner",
    ...
    modules: [
      {
        ...
        description:
          "User Experience (UX) and User Interface (UI) design are distinctly separate yet deeply interconnected disciplines. UX encompasses the overarching cognitive and emotional journey a user experiences while interacting with a product, prioritizing usability, efficiency, and logical flow. UI, conversely, represents the tangible visual touchpoints—typography, color, and layout—through which that interaction occurs. The foundation of successful UI/UX lies in Design Thinking, an iterative process prioritizing profound user empathy over rigid assumption. By adhering to Gestalt principles of visual perception and strict accessibility guidelines (such as WCAG), designers construct interfaces that naturally guide user attention and ensure equitable access for all demographics.",
        lessonsCompleted: 0,
        totalLessons: 5,
        lessons: [
          {
            id: "l1",
            title: "1. What is UI vs UX?",
            duration: "05:30",
            isCompleted: false,
            videoUrl: "https://example.com/ui1",
            description:
              "Understanding the difference and synergy between User Interface and User Experience.",
          },
          {
            id: "l2",
            title: "2. The Design Process",
            duration: "08:15",
            isCompleted: false,
            videoUrl: "https://example.com/ui2",
            description:
              "A high-level view of standard product design workflows.",
          },
          {
            id: "l3",
            ...
            duration: "10:45",
            isCompleted: false,
            videoUrl: "https://example.com/ui3",
          ...
          },
          {
            ...
            duration: "07:20",
            isCompleted: false,
            videoUrl: "https://example.com/ui4",
            description:
              "Guiding the user's eye using scale, color, and layout.",
          },
          {
            id: "l5",
            title: "5. Accessibility in Design",
            duration: "09:10",
            isCompleted: false,
            videoUrl: "https://example.com/ui5",
            description:
              "Ensuring your designs are usable by everyone, including people with disabilities.",
          },
        ],
      },
      {
        ...
        description:
          "Empirical research is the bedrock of objective design decisions, mitigating the inherent biases of the design team. Qualitative research, often conducted via semi-structured user interviews, seeks to understand the 'why' behind user behaviors, uncovering latent motivations and frustrations. This qualitative data is synthesized into User Personas: archetypical representations of core demographic segments that serve to anchor design decisions in human empathy. Subsequent mapping of User Journeys visually articulates the sequential phases a user navigates to achieve a specific goal, highlighting critical friction points. Concurrently, Information Architecture (IA) establishes the ontological structure of the product's content, ensuring intuitive navigability.",
        lessonsCompleted: 0,
        totalLessons: 5,
        lessons: [
          {
            id: "l6",
            title: "6. Conducting User Interviews",
            duration: "12:00",
            isCompleted: false,
            videoUrl: "https://example.com/ui6",
            description:
              "How to ask the right questions to uncover real user problems.",
          },
          {
            id: "l7",
            title: "7. Creating User Personas",
            duration: "08:45",
            isCompleted: false,
            videoUrl: "https://example.com/ui7",
            description:
              "Synthesizing research into actionable user archetypes.",
          },
          {
            id: "l8",
            title: "8. User Journeys & Flows",
            duration: "11:30",
            isCompleted: false,
            videoUrl: "https://example.com/ui8",
            description:
              "Mapping out the steps a user takes to achieve a goal.",
          },
          {
            id: "l9",
            ...
            duration: "14:15",
            isCompleted: false,
            videoUrl: "https://example.com/ui9",
            description:
              "Organizing content logically and creating intuitive navigation.",
          },
          {
            id: "l10",
            ...
            duration: "09:50",
            isCompleted: false,
            videoUrl: "https://example.com/ui10",
            description: "Learning from industry competitors and finding gaps.",
          },
        ],
      },
      {
        ...
        description:
          "Modern interface design is predominantly executed within vector graphics editors like Figma, which allow for infinite scalability without resolution degradation. The construction of robust interfaces relies on atomic design principles, wherein elemental shapes and typographic rules are combined into complex, reusable Components. Auto Layout systems enforce mathematical consistency in padding and responsive resizing behavior. The design lifecycle transitions from wireframing (low-fidelity structural blueprints) to high-fidelity mockups encompassing definitive branding. Finally, these static frames are connected via prototyping tools to simulate state changes, micro-interactions, and navigational transitions, yielding a testable artifact prior to engineering handoff.",
        lessonsCompleted: 0,
        totalLessons: 5,
        lessons: [
          {
            id: "l11",
            title: "11. Getting Started with Figma",
            duration: "15:20",
            isCompleted: false,
            videoUrl: "https://example.com/ui11",
            description: "Touring the interface and basic shapes.",
          },
          {
            id: "l12",
            title: "12. Auto Layout & Components",
            duration: "18:40",
            isCompleted: false,
            videoUrl: "https://example.com/ui12",
            description: "Building responsive and reusable design elements.",
          },
          {
            id: "l13",
            title: "13. Wireframing",
            duration: "13:10",
            isCompleted: false,
            videoUrl: "https://example.com/ui13",
            description: "Sketching out low-fidelity layouts.",
          },
          {
            id: "l14",
            title: "14. High-Fidelity Design",
            duration: "22:00",
            isCompleted: false,
            videoUrl: "https://example.com/ui14",
            description: "Adding color, typography, and imagery to wireframes.",
          },
          {
            id: "l15",
            title: "15. Interactive Prototyping",
            duration: "16:30",
            isCompleted: false,
            videoUrl: "https://example.com/ui15",
            description:
              "Connecting screens and adding animations for user testing.",
          },
        ],
      },
    ],
    overview: {
      ...
      detailedDescription:
        "Master the art of creating beautiful and functional digital products. This course covers everything from color theory and typography to advanced prototyping and user testing.",
      syllabus: [
    ...
    instructors: [
      {
        ...
        role: "Design Lead",
        avatar:
          "https://app.paper.design/file-assets/01KPZWMJ3H4NEREG0PQ8WG2GWM/71D39XQ7T5T6X7YR0XTTDXRA9J.jpg",
        ...
        coursesOnPlatform: [
          {
            ...
            thumbnail: "https://example.com/figma.jpg",
            price: 39,
            rating: 4.9,
          },
        ],
  ...
  "graphics-design": {
    ...
    description:
      "Design stunning visuals and brand identities like a pro using Photoshop, Illustrator and more.",
    rating: 4.9,
    reviewsCount: "1.1k",
    studentsCount: "5,210",
    level: "All Levels",
    ...
    modules: [
      {
        ...
        description:
          "Graphic design is the formal arrangement of visual elements to communicate a specific message or evoke a targeted response. The foundational grammar of this visual language consists of the Elements of Art—line, shape, form, space, texture, and color. These elements are orchestrated according to the Principles of Design, which dictate how balance (symmetrical or asymmetrical), contrast, emphasis, and rhythm are deployed to establish visual hierarchy. A fundamental technical distinction in digital design is between raster and vector formats. Raster graphics consist of a fixed grid of colored pixels, resolution-dependent and prone to degradation when scaled, whereas vector graphics are defined by mathematical curves and polygons, allowing infinite, lossless scalability.",
        lessonsCompleted: 0,
        totalLessons: 5,
        lessons: [
          {
            id: "l1",
            title: "1. Introduction to Graphics Design",
            duration: "06:20",
            isCompleted: false,
            videoUrl: "https://example.com/gd1",
            description: "What graphics design is and where it is applied.",
          },
          {
            id: "l2",
            title: "2. The Principles of Design",
            duration: "11:45",
            isCompleted: false,
            videoUrl: "https://example.com/gd2",
            description:
              "Balance, contrast, emphasis, movement, pattern, and rhythm.",
          },
          {
            id: "l3",
            title: "3. Elements of Art",
            duration: "09:30",
            isCompleted: false,
            videoUrl: "https://example.com/gd3",
            description: "Lines, shapes, forms, space, and texture.",
          },
          {
            id: "l4",
            title: "4. Raster vs Vector Graphics",
            duration: "07:15",
            isCompleted: false,
            videoUrl: "https://example.com/gd4",
            description:
              "Understanding resolution and file types (JPG, PNG, SVG, EPS).",
          },
          {
            id: "l5",
            title: "5. Setting Up Your Workspace",
            duration: "05:50",
            isCompleted: false,
            videoUrl: "https://example.com/gd5",
            description:
              "Hardware and software recommendations for modern designers.",
          },
        ],
      },
      {
      ...
      },
      {
        ...
        lessons: [
          {
            id: "l11",
            title: "11. Intro to Illustrator Workspace",
            duration: "15:00",
            isCompleted: false,
            videoUrl: "https://example.com/gd11",
            description: "Navigating tools, panels, and artboards.",
          },
          {
            id: "l12",
            title: "12. The Pen Tool Masterclass",
            duration: "22:30",
            isCompleted: false,
            videoUrl: "https://example.com/gd12",
            description: "Drawing perfect curves and tracing sketches.",
          },
          {
            id: "l13",
            title: "13. Shape Builder & Pathfinder",
            duration: "13:20",
            isCompleted: false,
            videoUrl: "https://example.com/gd13",
            description: "Combining simple shapes into complex illustrations.",
          },
          {
            id: "l14",
            title: "14. Typography in Illustrator",
            duration: "09:45",
            isCompleted: false,
            videoUrl: "https://example.com/gd14",
            description: "Type on a path and custom lettering techniques.",
          },
          {
            id: "l15",
            title: "15. Logo Design Project",
            duration: "25:10",
            isCompleted: false,
            videoUrl: "https://example.com/gd15",
            description: "Building a brand mark from scratch.",
          },
        ],
      },
      {
        ...
        description:
          "Raster image manipulation requires a pixel-level approach fundamentally different from vector drafting. Professional raster workflows are predicated on non-destructive editing, a paradigm wherein the original image data is never permanently altered. This is achieved through the use of Layers, which stack graphical elements independently, and Layer Masks, which utilize grayscale values to conceal or reveal portions of a layer without deleting pixels. Adjustment Layers apply tonal and chromatic corrections parametrically. Advanced compositing integrates disparate photographic elements by meticulously matching lighting, perspective, and atmospheric perspective, resulting in a cohesive, photorealistic digital synthesis.",
        lessonsCompleted: 0,
        totalLessons: 5,
        lessons: [
          {
            id: "l16",
            title: "16. Intro to Photoshop Workspace",
            duration: "14:15",
            isCompleted: false,
            videoUrl: "https://example.com/gd16",
            description: "Understanding layers, masks, and adjustment layers.",
          },
          {
            id: "l17",
            title: "17. Selection & Masking Tools",
            duration: "18:50",
            isCompleted: false,
            videoUrl: "https://example.com/gd17",
            description: "Cutting out subjects perfectly.",
          },
          {
            id: "l18",
            title: "18. Photo Retouching",
            duration: "20:00",
            isCompleted: false,
            videoUrl: "https://example.com/gd18",
            description: "Removing blemishes and enhancing lighting/color.",
          },
          {
            id: "l19",
            title: "19. Photo Compositing",
            duration: "28:30",
            isCompleted: false,
            videoUrl: "https://example.com/gd19",
            description: "Blending multiple images into a seamless scene.",
          },
          {
            id: "l20",
            title: "20. Social Media Assets Project",
            duration: "21:10",
            isCompleted: false,
            videoUrl: "https://example.com/gd20",
            description: "Creating banners, thumbnails, and posts.",
          },
        ],
      },
    ],
    overview: {
      ...
      detailedDescription:
        "A comprehensive deep dive into professional graphic design. From mastering the pen tool in Illustrator to advanced non-destructive photo manipulation in Photoshop, this course is built to take you from a blank canvas to a stunning professional portfolio.",
      syllabus: [
    ...
    instructors: [
      {
        ...
        avatar:
          "https://ui-avatars.com/api/?name=Lindsay+Marsh&background=random",
        ...
        coursesOnPlatform: [
          {
            id: "logo-design",
            title: "Logo Design Theory & Application",
            thumbnail: "https://example.com/logo-course.jpg",
            price: 35,
            rating: 4.7,
          },
        ],
  ...
  "digital-marketing": {
    ...
    description:
      "Master digital marketing and grow any business online with SEO, Social Media, and Ads.",
    rating: 4.8,
    reviewsCount: 743,
    ...
    modules: [
      ...
      },
      {
        ...
        description:
          "Search Engine Optimization (SEO) is the technical and semantic methodology of increasing the quantity and quality of organic search traffic. Search engine algorithms utilize automated crawlers to index the web, ranking pages based on complex heuristics of relevance and authority. Relevance is established through On-Page SEO: the strategic inclusion of thoroughly researched keywords within semantic HTML tags, metadata, and high-value written content. Authority is primarily determined by Off-Page SEO, most notably the accumulation of quality backlinks from external domains, functioning as independent votes of confidence. Content marketing aligns with SEO by continuously generating educational or entertaining assets that naturally satisfy user search intent.",
        lessonsCompleted: 0,
        totalLessons: 4,
        lessons: [
          {
            id: "l5",
            title: "5. Introduction to SEO",
            duration: "15:40",
            isCompleted: false,
            videoUrl: "https://example.com/dm5",
            description: "How search engines work and rank pages.",
          },
          {
            id: "l6",
            title: "6. Keyword Research Strategy",
            duration: "18:15",
            isCompleted: false,
            videoUrl: "https://example.com/dm6",
            description: "Finding high-volume, low-competition terms.",
          },
          {
            id: "l7",
            title: "7. On-Page & Off-Page Optimization",
            duration: "21:00",
            isCompleted: false,
            videoUrl: "https://example.com/dm7",
            description: "Meta tags, backlinks, and website architecture.",
          },
          {
            id: "l8",
            title: "8. Content Creation & Distribution",
            duration: "16:20",
            isCompleted: false,
            videoUrl: "https://example.com/dm8",
            description: "Writing blogs that rank and convert.",
          },
        ],
      },
      {
        ...
        lessons: [
          {
            id: "l9",
            title: "9. Social Media Strategy",
            duration: "13:30",
            isCompleted: false,
            videoUrl: "https://example.com/dm9",
            description: "Choosing platforms and creating a content calendar.",
          },
          {
            id: "l10",
            title: "10. Facebook & Instagram Ads",
            duration: "25:45",
            isCompleted: false,
            videoUrl: "https://example.com/dm10",
            description:
              "Setting up Business Manager and launching your first campaign.",
          },
          {
            id: "l11",
            title: "11. Google Ads (PPC) Basics",
            duration: "22:10",
            isCompleted: false,
            videoUrl: "https://example.com/dm11",
            description: "Search, Display, and Performance Max campaigns.",
          },
          {
            id: "l12",
            title: "12. Email Marketing Fundamentals",
            duration: "14:05",
            isCompleted: false,
            videoUrl: "https://example.com/dm12",
            description: "Building a list and sending automated sequences.",
          },
        ],
      },
    ],
    overview: {
      ...
      detailedDescription:
        "Learn how to grow any business online from scratch. This course covers the entire digital marketing spectrum including Search Engine Optimization (SEO), Pay-Per-Click (PPC) advertising, social media strategies, and high-conversion email marketing.",
      syllabus: [
    ...
    instructors: [
      {
        ...
        avatar:
          "https://ui-avatars.com/api/?name=Sarah+Strategy&background=random",
        ...
        coursesOnPlatform: [
          {
            id: "fb-ads-pro",
            title: "Facebook Ads Profitability Masterclass",
            thumbnail: "https://example.com/fb-ads.jpg",
            price: 45,
            rating: 4.8,
          },
        ],
